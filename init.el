...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (anki-editor hyperbole leuven-theme zenburn-theme xah-fly-keys which-key sublime-themes sourcerer-theme org-journal org-brain ob-ipython magit golden-ratio el-get conda cider 4clojure))))
(custom-set-faces
