...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (dim cyphejor telephone-line leuven-theme zenburn-theme xah-fly-keys which-key sublime-themes sourcerer-theme org-journal org-brain ob-ipython magit golden-ratio el-get conda cider 4clojure))))
(custom-set-faces
