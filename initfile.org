...
(setq package-list '(el-get magit dash dash-functional
		     ...
		     clojure-mode cl leuven-theme deft org-brain
...
(setq org-todo-keyword-faces
  '(("TODO" . org-warning)
   ("WAITING" . (:background "orange" :foreground "dim grey"))
   ("EVENT" . (:background "grey" :foreground "dim grey"))
   ("PROJECT" . (:background "deep sky blue" :foreground "dim grey"))
   ("DONE" . (:background "green" :foreground "dim grey"))
   ("CANCELLED" .  (:background "yellow" :foreground "dim grey"))))
