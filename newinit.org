...
Overpass Mono is currently the best programming font that I know of. Its regular sans companion font unifies the interface very well.
#+begin_src emacs-lisp :tangle yes
...
(set-face-font 'mode-line "Overpass Mono-10.5")
(set-face-font 'mode-line-inactive "Overpass Mono-10.5")
(set-face-font 'linum "Overpass Mono-10.5")
